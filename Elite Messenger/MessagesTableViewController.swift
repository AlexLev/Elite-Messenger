...
class MessagesTableViewController: UITableViewController, UITextFieldDelegate {
    ...
    var secondUserObjectId:String = String()
...
//        tableView.registerClass(UITableViewCell.self, forCellReuseIdentifier: "messageCell")
    ...
    func loadMesseges() {
        let predicate =  NSPredicate(format: "(toUser = %@ and fromUser = %@) or (toUser = %@ and fromUser = %@)", PFUser.currentUser()!, secondUserObjectId, secondUserObjectId, PFUser.currentUser()!)
